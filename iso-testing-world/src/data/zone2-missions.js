/**
 * Zone 2 — V&V Headquarters: 8 missions.
 *
 * 3 verification, 3 validation, 2 both. Exactly one mission carries the
 * Oracle prompt (m4 — middle of the run). Order is fixed; mission queue
 * advances strictly left to right.
 *
...
export const ZONE2_PER_MISSION = 25;        // 200 / 8
export const ZONE2_PARTIAL_BOTH = 12;       // half-credit when "both" justified poorly
